"""
Django settings for mtube_48812 project.
...
WSGI_APPLICATION = 'mtube_48812.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Mtube Support <support@mtube-48812.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mtube_48812 API",
    "DESCRIPTION": "API documentation for mtube_48812 App",
    "VERSION": "v1",
}
